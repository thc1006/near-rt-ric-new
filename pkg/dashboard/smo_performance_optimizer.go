...
// MessageType type and constants are now defined in types.go to avoid redeclaration
...
// ErrorHandler function type is now defined in types.go to avoid redeclaration

// OptimizedMessage type is now defined in types.go to avoid redeclaration

// ProcessedMessage type is now defined in types.go to avoid redeclaration

// MessagePriority type is now defined in types.go to avoid redeclaration

// SMOClient type is now defined in types.go to avoid redeclaration

// NonRTRICClient type is now defined in types.go to avoid redeclaration
